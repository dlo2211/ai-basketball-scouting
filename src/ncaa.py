...
def scrape_from_ncaa(player: Dict[str, str]) -> Dict[str, Any]:
    ...
    if resp.status_code != 200:
        return {"status": resp.status_code, "ppg": None, "rpg": None, "apg": None, "source": "ncaa", "note": f"NCAA {resp.status_code}"}
    ...
    try:
        ...
        return {"status": 200, "ppg": ppg, "rpg": rpg, "apg": apg, "source": "ncaa", "note": ""}
    except Exception:
        return {"status": 200, "ppg": None, "rpg": None, "apg": None, "source": "ncaa", "note": "NCAA parse failed"}
